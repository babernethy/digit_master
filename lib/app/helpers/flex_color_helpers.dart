...
///https://github.com/rydmike/flex_seed_scheme/blob/master/example/lib/custom_tones.dart
...
ColorScheme schemeLight(
        {required Color primarySeedColor,
        required bool keepAllOnColorsBW,
        Color? secondarySeedColor,
        Color? tertiarySeedColor}) =>
    selectedSeedScheme(
      ...
      tones: FlexTonesEnum.custom
          .tones(Brightness.light)
          .onMainsUseBW(keepAllOnColorsBW)
          .onSurfacesUseBW(keepAllOnColorsBW),
      useSecondaryKey: secondarySeedColor != null,
      useTertiaryKey: tertiarySeedColor != null,
    );
